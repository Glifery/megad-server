...
public class GoogleAuthorizeUtil {
    public static Credential authorize(SpreadsheetConfig spreadsheetConfig) throws IOException, GeneralSecurityException {

        InputStream in = GoogleAuthorizeUtil.class.getResourceAsStream(spreadsheetConfig.getCredentialsJson());
        ...
        GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(GoogleNetHttpTransport.newTrustedTransport(), JacksonFactory.getDefaultInstance(), clientSecrets, scopes)
                .setDataStoreFactory(new FileDataStoreFactory(new java.io.File(spreadsheetConfig.getTokensFolder())))
